import Viewallherosectionimage from '../../../assets/skillorientedviewallherosectionimage.png'
      ...
      <div className="container mx-auto px-4 md:px-12 py-8 md:py-5">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className=" md:w-[850px] md:px-0 px-2 space-y-6">
            <h1 className="text-white text-[32px] md:text-nowrap leading-[36px] md:text-[48px] font-bold md:leading-[30px]  ">
            Course with{' '}
            ...
            <div className="flex flex-wrap gap-4">
              <div className=" border-[1px] rounded-[10px]  border-[#F2B331] text-white px-4 py-2 md:text-[18px] text-[16px]  ">
                Over all reviews - <span className='md:text-[18px] text-[#F2B331]'>4.3</span>
              </div>
              <div className=" border-[1px] rounded-[10px] border-[#F2B331] md:text-[18px] text-white px-4 py-2  text-[16px]">
