      ...
      <div className=" md:pl-24 ">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 overflow-hidden md:px-0 px-8  md:overflow-visible items-center">
          ...
          <div className="overflow-hidden md:overflow-visible md:mt-2">
            ...
            <h1 className="text-[32px] leading-[36px] mt-2 md:mt-2 md:text-[48px] md:leading-[60px] lg:text-[48px] md:w-[120%] w-[80%] lg:leading-[66px] font-bold text-[#1D1F71]">
          ...
          <div className="mt-8 md:mt-2">
            <img 
              ...
              className="w-full h-full md:mt-9  rounded-lg object-cover"
            />
          </div>
        </div>
      </div>
